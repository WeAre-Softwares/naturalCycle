...
export const Checkout = () => {
  ...
  const realizarCompra = () => {
    const isBillingComplete = Object.values(billingInfo).every((value) => value.trim() !== '');
  ...
  return (
    <div className="checkout-container-general">
      ...
      <h2>Resumen de compra</h2></div>
      
      {/* Formulario de facturación */}
      <div className="div-h3-form-facturacion">
      <h3>Datos de Facturación</h3></div>
      ...
      {carrito.length === 0 ? (
        ...
        <div className='container-prod-checkout'>
          ...
          <h3>Precio total del pedido: ${calcularSubtotal().toLocaleString()}</h3>
          <div className="div-button-container-prod-checkout"> <button className="btn-finalizar-compra" onClick={realizarCompra}>Confirmar Pedido</button></div>
        </div>
