...
const OlvideContraseña = () => {
  return (
      <div className="olvide-contraseña-container">
        <h3>Rellená el siguiente formulario y te llegará un mail para reestablecer tu contraseña.</h3>
      <div className="olvide-contraseña-form-container">
        ...
        <form className="olvide-contraseña-form-pass">
          ...
          <button className="olvide-contraseña-form-submit-btn" type="submit">Enviar</button>
        </form>

        <p className="olvide-contraseña-signup-link">
          ¿Aún no tienes una cuenta?
          <Link to="/register" className="olvide-contraseña-signup-link olvide-contraseña-link"> Registrarme</Link>
        </p>
      </div>
    </div>
  )
