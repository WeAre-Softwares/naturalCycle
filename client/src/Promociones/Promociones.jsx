...
const productosPromocion = [
  { id: 1, nombre: 'Producto 1', precio: 100, stock: 10, img: 'https://via.placeholder.com/150' },
  { id: 2, nombre: 'Producto 2', precio: 200, stock: 5, img: 'https://via.placeholder.com/150' },
  { id: 3, nombre: 'Producto 3', precio: 300, stock: 8, img: 'https://via.placeholder.com/150' },
  { id: 4, nombre: 'Producto 4', precio: 400, stock: 0, img: 'https://via.placeholder.com/150' },
  { id: 5, nombre: 'Producto 5', precio: 500, stock: 2, img: 'https://via.placeholder.com/150' },
  { id: 6, nombre: 'Producto 6', precio: 600, stock: 7, img: 'https://via.placeholder.com/150' },
  { id: 7, nombre: 'Producto 7', precio: 700, stock: 0, img: 'https://via.placeholder.com/150' },
  { id: 8, nombre: 'Producto 8', precio: 800, stock: 9, img: 'https://via.placeholder.com/150' },
  { id: 9, nombre: 'Producto 9', precio: 900, stock: 6, img: 'https://via.placeholder.com/150' },
  { id: 10, nombre: 'Producto 10', precio: 1000, stock: 4, img: 'https://via.placeholder.com/150' }
];
...
const Promociones = () => {
  ...
  const handlePrevClick = () => {
    carruselRef.current.scrollBy({ left: -carruselRef.current.offsetWidth, behavior: 'smooth' });
  };
  ...
  return (
    <div className="container-general-promociones">
      <div className="container-h2-promociones">
        <h2>PROMOCIONES</h2>
        <h4>Descubre nuestras ofertas especiales y promociones diseñadas para brindarte los mejores productos al mejor precio. 
          Aquí encontrarás descuentos exclusivos en una amplia variedad de artículos, 
          seleccionados cuidadosamente para satisfacer todas tus necesidades. 
          ¡Aprovecha estas oportunidades antes de que se agoten y lleva lo mejor a tu hogar!</h4>
      </div>
